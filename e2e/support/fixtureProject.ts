 ...
 * never committed to the Thor repository): a truly empty folder
...
/**
 * Low-level setup via raw `git` (Node `child_process`, NEVER via Thor)
 ...
 * commands as Thor, a bug there could mask the test's own
 * setup.
 */
 ...
 * any Thor API. It's the counterpoint to "the app says it initialized";
...
/**
 * Direct commit (outside Thor) on a specific branch, touching `filePath`
 ...
 * repository (never via Thor) and confirms the expected content really is
