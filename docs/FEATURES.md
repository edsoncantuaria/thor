...
Thor supports layouts at project, group, and workspace level.
...
Agent Planning / Agent Canvas is experimental. It provides a visual control surface for coordinating agent sessions and workers from inside Thor.
