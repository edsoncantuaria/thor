export const en = {
  ...
  'onboarding.externalEditorTitle': 'External editor',
  'onboarding.externalEditorSubtitle':
    'Pick the editor "Open in Editor" actions on a terminal should launch.',
  ...
  'prefs.ollama': 'Ollama',
  'prefs.ollamaDesc':
    'Run local models with Ollama — install it, pull models, and run several instances so different agent panes can use their own local model at once.',
  'prefs.ollamaNotInstalled': 'Ollama is not installed.',
  'prefs.ollamaInstall': 'Install Ollama',
  'prefs.ollamaInstalling': 'Installing…',
  'prefs.ollamaInstalled': 'Ollama is installed.',
  'prefs.ollamaModels': 'Models',
  'prefs.ollamaModelsEmpty': 'No models pulled yet.',
  'prefs.ollamaPullPlaceholder': 'Model to pull, e.g. llama3.2:3b',
  'prefs.ollamaPull': 'Pull',
  'prefs.ollamaPulling': 'Pulling {model}…',
  'prefs.ollamaInstances': 'Running instances',
  'prefs.ollamaInstancesEmpty': 'No instances running.',
  'prefs.ollamaInstancePort': 'Port {port}',
  'prefs.ollamaStartInstance': 'Start instance',
  'prefs.ollamaStopInstance': 'Stop',
  'prefs.ollamaSelectModel': 'Select a model',
  'localAi.title': 'Local AI',
  'localAi.subtitle': 'Run local models with Ollama, and see what they are actually using.',
  'localAi.notInstalledTitle': 'Ollama is not installed',
  'localAi.notInstalledDesc': 'Install it from Preferences ▸ Integrations to run local models.',
  'localAi.openPreferences': 'Open Preferences',
  'localAi.selectModel': 'Select a model',
  'localAi.start': 'Start',
  'localAi.starting': 'Starting…',
  'localAi.noInstancesTitle': 'No models running',
  'localAi.noInstancesDesc': 'Pick a model above and start it to see it here.',
  'localAi.unnamedModel': 'Local model',
  'localAi.stop': 'Stop',
  'localAi.stopping': 'Stopping…',
  'localAi.port': 'port {port}',
  'localAi.pid': 'pid {pid}',
  'localAi.cpu': 'CPU',
  'localAi.ram': 'RAM',
  'localAi.gpu': 'GPU',
  ...
  'localAi.throughputUnavailable': 'Throughput not tracked for this instance (proxy unavailable).',
  'localAi.externalTitle': 'External daemon',
  'localAi.externalBadge': 'Not managed by Thor',
  'localAi.externalDesc':
    "Ollama is already running outside Thor (a system service, or started by hand). Thor can't start, stop, or track usage for it — only list what it's serving.",
  'prefs.optimizer': 'Token optimizer',
  'prefs.optimizerDesc':
    'Caveman and Headroom wrap an agent CLI to cut token usage — pick at most one, since both intercept the same mechanism. RTK is a separate one-time hook for Claude Code and can be used together with either.',
  'prefs.optimizerNone': 'None',
  'prefs.optimizerNotInstalled': 'Not installed',
  'prefs.optimizerInstalled': 'Installed',
  'prefs.optimizerInstall': 'Install',
  'prefs.optimizerInstalling': 'Installing…',
  'prefs.optimizerRtkConfigure': 'Run rtk init -g',
  'prefs.optimizerRtkConfiguring': 'Running…',
  'prefs.externalEditor': 'External editor',
  'prefs.externalEditorDesc':
    'Editor launched by "Open in Editor" actions on a terminal — VS Code, Cursor, or any other VS Code-based IDE.',
  'prefs.externalEditorVscode': 'VS Code',
  'prefs.externalEditorCursor': 'Cursor',
  'prefs.externalEditorOther': 'Other (VS Code-based)',
  'prefs.externalEditorCustomPlaceholder': 'Command or path, e.g. windsurf',
  'prefs.externalEditorFallbackLabel': 'Editor',
  'prefs.orchestratorBuckets': 'Orchestrator worker buckets',
  'prefs.orchestratorBucketsDesc':
    'Configure which agent CLIs the orchestrator can delegate to, and pick a bucket per task.',
  'prefs.orchestratorBucketsHint':
    'Codex and OpenCode are detected automatically when installed — add a bucket here for anything else: Claude in print mode, Cursor, or a second OpenCode pointed at a local Ollama model. "Steerable" locks in Codex\'s persistent protocol; "One-shot" runs any CLI as command [args] [model flag] task and captures the reply. Set a fallback bucket and, if this one fails with what looks like a quota or rate-limit error, Thor automatically retries the same task there — e.g. a Claude Sonnet bucket falling back to Gemini Flash.',
  'prefs.orchestratorBucketLabel': 'Label',
  'prefs.orchestratorBucketCommand': 'Command (e.g. opencode)',
  'prefs.orchestratorBucketModel': 'Default model (optional)',
  ...
  'theme.elite-gold.label': 'Elite Gold',
  'theme.elite-gold.desc': 'Near-black workspace with a gold accent.',
  ...
  'ui.terminal.openInEditor': 'Open in {name}',
