...
export const ptBR: Record<MessageKey, string> = {
  ...
  'onboarding.externalEditorTitle': 'Editor externo',
  'onboarding.externalEditorSubtitle':
    'Escolha o editor que as ações "Abrir no editor" de um terminal devem abrir.',
  ...
  'prefs.ollama': 'Ollama',
  'prefs.ollamaDesc':
    'Rode modelos locais com Ollama — instale, baixe modelos, e suba várias instâncias para que agentes diferentes usem cada um o seu modelo local ao mesmo tempo.',
  'prefs.ollamaNotInstalled': 'O Ollama não está instalado.',
  'prefs.ollamaInstall': 'Instalar Ollama',
  'prefs.ollamaInstalling': 'Instalando…',
  'prefs.ollamaInstalled': 'O Ollama está instalado.',
  'prefs.ollamaModels': 'Modelos',
  'prefs.ollamaModelsEmpty': 'Nenhum modelo baixado ainda.',
  'prefs.ollamaPullPlaceholder': 'Modelo para baixar, ex: llama3.2:3b',
  'prefs.ollamaPull': 'Baixar',
  'prefs.ollamaPulling': 'Baixando {model}…',
  'prefs.ollamaInstances': 'Instâncias rodando',
  'prefs.ollamaInstancesEmpty': 'Nenhuma instância rodando.',
  'prefs.ollamaInstancePort': 'Porta {port}',
  'prefs.ollamaStartInstance': 'Iniciar instância',
  'prefs.ollamaStopInstance': 'Parar',
  'prefs.ollamaSelectModel': 'Selecione um modelo',
  'localAi.title': 'IA Local',
  'localAi.subtitle': 'Rode modelos locais com Ollama e veja o que eles estão realmente usando.',
  'localAi.notInstalledTitle': 'Ollama não está instalado',
  'localAi.notInstalledDesc': 'Instale em Preferências ▸ Integrações para rodar modelos locais.',
  'localAi.openPreferences': 'Abrir Preferências',
  'localAi.selectModel': 'Selecione um modelo',
  'localAi.start': 'Iniciar',
  'localAi.starting': 'Iniciando…',
  'localAi.noInstancesTitle': 'Nenhum modelo rodando',
  'localAi.noInstancesDesc': 'Escolha um modelo acima e inicie para ver aqui.',
  'localAi.unnamedModel': 'Modelo local',
  'localAi.stop': 'Parar',
  'localAi.stopping': 'Parando…',
  'localAi.port': 'porta {port}',
  'localAi.pid': 'pid {pid}',
  'localAi.cpu': 'CPU',
  'localAi.ram': 'RAM',
  'localAi.gpu': 'GPU',
  'localAi.throughput': 'Throughput',
  'localAi.tokensPerSecond': '{value} tok/s',
  'localAi.requests': 'Requests',
  'localAi.throughputUnavailable': 'Throughput não rastreado para esta instância (proxy indisponível).',
  'localAi.externalTitle': 'Daemon externo',
  'localAi.externalBadge': 'Não gerenciado pelo Thor',
  'localAi.externalDesc':
    'O Ollama já está rodando fora do Thor (um serviço de sistema, ou iniciado manualmente). O Thor não consegue iniciar, parar ou rastrear o uso dele — só listar o que está servindo.',
  'prefs.optimizer': 'Otimização de tokens',
  'prefs.optimizerDesc':
    'Caveman e Headroom envolvem o CLI de um agente pra reduzir uso de tokens — escolha no máximo um, já que os dois interceptam o mesmo mecanismo. RTK é um hook separado de configuração única pro Claude Code e pode ser usado junto com qualquer um dos dois.',
  'prefs.optimizerNone': 'Nenhum',
  'prefs.optimizerNotInstalled': 'Não instalado',
  'prefs.optimizerInstalled': 'Instalado',
  'prefs.optimizerInstall': 'Instalar',
  'prefs.optimizerInstalling': 'Instalando…',
  'prefs.optimizerRtkConfigure': 'Rodar rtk init -g',
  'prefs.optimizerRtkConfiguring': 'Rodando…',
  'prefs.externalEditor': 'Editor externo',
  'prefs.externalEditorDesc':
    'Editor aberto pelas ações "Abrir no editor" de um terminal — VS Code, Cursor, ou qualquer outra IDE baseada no VS Code.',
  'prefs.externalEditorVscode': 'VS Code',
  'prefs.externalEditorCursor': 'Cursor',
  'prefs.externalEditorOther': 'Outra (baseada no VS Code)',
  'prefs.externalEditorCustomPlaceholder': 'Comando ou caminho, ex.: windsurf',
  'prefs.externalEditorFallbackLabel': 'Editor',
  'prefs.orchestratorBuckets': 'Buckets de workers do orquestrador',
  'prefs.orchestratorBucketsDesc':
    'Configure para quais CLIs de agente o orquestrador pode delegar, e escolha um bucket por tarefa.',
  'prefs.orchestratorBucketsHint':
    'Codex e OpenCode são detectados automaticamente quando instalados — adicione um bucket aqui para qualquer outro caso: Claude em modo print, Cursor, ou um segundo OpenCode apontando para um modelo Ollama local. "Direcionável" trava no protocolo persistente do Codex; "Um disparo" roda qualquer CLI como command [args] [flag do modelo] tarefa e captura a resposta. Defina um bucket de fallback e, se este falhar com algo que pareça limite de quota ou rate limit, o Thor tenta a mesma tarefa automaticamente nele — por exemplo, um bucket Claude Sonnet caindo para Gemini Flash.',
  'prefs.orchestratorBucketLabel': 'Rótulo',
  'prefs.orchestratorBucketCommand': 'Comando (ex.: opencode)',
  'prefs.orchestratorBucketModel': 'Modelo padrão (opcional)',
  ...
  'theme.elite-gold.label': 'Elite Dourado',
  'theme.elite-gold.desc': 'Fundo quase preto com acento dourado.',
  ...
  'ui.terminal.openInEditor': 'Abrir no {name}',
