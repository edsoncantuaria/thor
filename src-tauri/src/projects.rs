...
fn generate_repo_context_files(project_dir: &str) -> Result<(), String> {
    ...
    let context_markdown = format!(
        "# Contexto Inicial do Projeto (Thor AI Briefing)\n\n\
        > Este repositório foi clonado via Thor. O briefing abaixo descreve a aplicação para orientar sua assistência.\n\n\
